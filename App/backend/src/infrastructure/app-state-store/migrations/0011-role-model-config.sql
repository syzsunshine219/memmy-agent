ALTER TABLE account_model_config
  ADD COLUMN memory_provider TEXT;

ALTER TABLE account_model_config
  ADD COLUMN memory_base_url TEXT;

ALTER TABLE account_model_config
  ADD COLUMN memory_model_id TEXT;

ALTER TABLE account_model_config
  ADD COLUMN memory_api_key_ref TEXT;

ALTER TABLE account_model_config
  ADD COLUMN skill_provider TEXT;

ALTER TABLE account_model_config
  ADD COLUMN skill_base_url TEXT;

ALTER TABLE account_model_config
  ADD COLUMN skill_model_id TEXT;

ALTER TABLE account_model_config
  ADD COLUMN skill_api_key_ref TEXT;
