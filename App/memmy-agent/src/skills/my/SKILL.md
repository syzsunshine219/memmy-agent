...
| Situation | Command |
|-----------|---------|
| Large codebase analysis | `my(action="set", key="contextWindowTokens", value=262144)` |
...
- Protected params have type/range validation: `maxIterations` (1–100), `contextWindowTokens` (4096–1M), `model` (non-empty string)
