...
```text
generate_image(
  prompt="A minimal app icon for memmy: friendly robot head, rounded square, soft blue and white palette, clean vector style, no text",
  aspect_ratio="1:1",
  image_size="1K"
)
```
...
generate_image(
  ...
  reference_images=["~/.memmy/media/generated/2026-05-08/img_ab12cd34ef56.png"],
  aspect_ratio="1:1",
  image_size="1K"
)
```
